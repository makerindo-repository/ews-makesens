    ...
    <div :class="{ 'block': sideopen, 'hidden': !sideopen }"
        ...
        <div class="flex-grow">
            <ul id="menu-inner"
                ...
                <li x-data="{
                    open: {{ request()->routeIs('iot-node.*') ||
                    request()->routeIs('public-node.*') ||
                    request()->routeIs('location.*') ||
                    request()->routeIs('volunteer.*') ||
                    request()->routeIs('raw-data.*')
                        ? 'true'
                        : 'false' }}
                    ...
                    <ul x-show="open" x-cloak class="ml-8 mt-1 space-y-1"
                        ...
                        <li>
                            <a href="{{ route('iot-node.index') }}" @class([
                                'menu-link',
                                'active-icon' => request()->routeIs('iot-node.*'),
                            ])>
                                <div class="text-sm"><span class="me-2">--</span> Data IoT Node</div>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('public-node.index') }}" @class([
                                'menu-link',
                                'active-icon' => request()->routeIs('public-node.*'),
                            ])>
                        ...
                        <li>
                            <a href="{{ route('location.index') }}" @class([
                                'menu-link',
                                'active-icon' => request()->routeIs('location.*'),
                            ])>
                                <div class="text-sm"><span class="me-2">--</span> Data Lokasi</div>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('volunteer.index') }}" @class([
                                'menu-link',
                                'active-icon' => request()->routeIs('volunteer.*'),
                            ])>
                                <div class="text-sm"><span class="me-2">--</span> Data Relawan</div>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('raw-data.index') }}" @class([
                                'menu-link',
                                'active-icon' => request()->routeIs('raw-data.*'),
                            ])>
                ...
                <li class="menu-item">
                    <a href="{{ route('report.index') }}" @class(['menu-link', 'active-icon' => request()->routeIs('report.*')])>
                ...
                <li class="menu-item">
                    <a href="{{ route('user.index') }}" class="menu-link" @class(['menu-link', 'active-icon' => request()->routeIs('user.*')])>
                ...
                <li class="menu-item">
                    <a href="{{ route('weather.index') }}" class="menu-link" @class([
                        'menu-link',
                ...
                <li x-data="{
                    open: {{ request()->routeIs('app-setting.*') || request()->routeIs('threshold.*') ? 'true' : 'false' }}
                }" class="menu-item w-full">
                    <button @click="open = !open" :aria-expanded="open"
                        class="menu-link w-full flex items-center pe-10 py-2 text-left">
                    ...
                    <ul x-show="open" x-cloak class="ml-8 mt-1 space-y-1"
                        ...
                        <li>
                            <a href="{{ route('app-setting.index') }}" @class([
                                'menu-link',
                                'active-icon' => request()->routeIs('app-setting.*'),
                            ])>
                                <div class="text-sm"><span class="me-2">--</span> Pengaturan Aplikasi</div>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('threshold.index') }}" @class([
                                'menu-link',
                                'active-icon' => request()->routeIs('threshold.*'),
                            ])>
                ...
                <li class="menu-item">
                    <a href="{{ route('activity-log.index') }}" class="menu-link" @class([
                        'menu-link',
