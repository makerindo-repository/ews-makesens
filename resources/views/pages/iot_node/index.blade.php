    ...
    <x-slot name="header">
        <h2 class="leading-tight">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item breadcrumb-active">{{ __('IoT Node') }}</li>
            </ol>
        </h2>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 flex flex-col gap-4">
            ...
            <div class="bg-white overflow-hidden shadow-sm">
                <div class="overflow-x-scroll">
                    <table class="w-full align-middle border-slate-400 table mb-0 px-2" id="iot-node-table">
                        <thead>
                            <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="h-full">
                                        <div class="flex items-center justify-center gap-3 h-full">
                                            <a href="{{ route('iot-node.edit', $node->id) }}" class="h-100">
                                                <i class="fa fa-pen text-primary"></i>
                                            </a>
                                            <form action="{{ route('iot-node.destroy', $node->id) }}" method="POST"
    ...
    @push('scripts')
        <script>
            ...
            $(document).ready(function() {
                table = $('#iot-node-table').DataTable({
                    responsive: true,
                    ordering: false,
                ...
                $('#iot-node-table_filter input').attr('placeholder', 'Cari Node...');
            });
